...
- ZeroMQ can be easily integrated into other programming languages and other devices, allowing for multi-peer networking with peers written in different programming languages to communicate seamlessly

- The ZeroMQ libraries are far simpler to use

- The size of the library is smaller

- Our development team had good prior experience with ZeroMQ
